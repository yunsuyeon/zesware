...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">ZESware company</a>
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">
              <strong>컴퓨터와 사람과의 융합</strong>
            </h1>
            <hr>
          </div>
          <div class="col-lg-8 mx-auto">
            <p class="text-faded mb-5">제스웨어의 임직원들은 고객 중심의 철저한 신뢰를 기반으로 하여 끊임없이 변화를 추구하고 노력하고 있습니다.
열정과 책임감을 가지고 고객사의 신뢰를 저버리지 않고, 한번 고객은 영원한 고객으로 다가서며,
고객(社)의 발전을 위해 최선을 다할 것을 약속드리겠습니다.<br>
부족한 부분이 있더라도 지켜봐주시고 응원해주셨으면 합니다.</p>
